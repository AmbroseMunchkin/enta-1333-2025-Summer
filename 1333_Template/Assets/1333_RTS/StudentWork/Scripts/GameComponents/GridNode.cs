...
namespace RTS_1333
{
	...
	public struct GridNode : IEquatable<GridNode>
	{
		...
		///     If set to false, the node is non-walkable and treated as an obstacle or restricted area during pathfinding
		///     computations.
		/// </remarks>
		...
		/// <summary>
		///     If the node is currently occupied by something
		///     Building occupy when they are placed, and only stop occupying when destroyed
		/// </summary>
